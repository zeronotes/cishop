<div class="grid_12">
    <form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
        <div class="header-content">Nhân bản danh mục sản phẩm</div>
        <div class="clear"></div>
        <div class="command">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="cateTitle" type="text" value="Clone of <?= $category['Title']?><?php echo set_value('cateTitle'); ?>" maxlength="500" id="cateTitle" class="TextInput" style="width:400px;" onchange="checkTitle(this);">
                                <span class="tooltip">
                        ...
                        <!-- <tr>
                            ...
                            <td>
                                <ul id="Keywords">
                                    <?php foreach ($keywordslist as $keys) { ?>
                                        <li><?= $keys ?></li>
                                    <?php } ?>
                                </ul>
                            </td>
