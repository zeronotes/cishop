                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="cateTitle" type="text" value="Clone of <?= $category['Title']?><?php echo set_value('cateTitle'); ?>" maxlength="500" id="cateTitle" class="TextInput" onchange="checkTitle(this);" style="width:400px;">
                                <span class="tooltip">
                            ...
                            <td>
                                <table id="tblUpload" cellspacing="0" cellpadding="0" width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img id="img_upload" src="<?= base_url()?>resources/uploads/images/automatic/thumbs/<?= $category['Banner']?>">
