<div class="grid_12">
    <div class="header-content">Danh sách độ phân giải</div>
    <div class="clear"></div>
    <div class="command">
                ...
                <tbody>
                    <?php $i = 1; foreach ($category_list as $key) :?>
                        <tr id="Row<?= $key['SortingResID']?>">
                            ...
                            <td align="center" style="width:150px;text-align:center;"><a href="<?= base_url()?>administrator/sorting/res/edit/<?= $key['SortingResID']?>">Chỉnh sửa</a> | <a href="<?= base_url()?>administrator/sorting/res/clone/<?= $key['SortingResID']?>">Nhân bản</a> | <a href="javascript:void(0);" onclick="showconfirm(<?= $key['SortingResID']?>,'Xác thực xóa danh mục','Xóa danh mục đồng nghĩa với việc xóa tất cả tin bán bất động sản thuộc danh mục này.<br/><br/>Bạn có chắc muốn xóa danh mục tin này?','delete')">xóa</a></td>
                        </tr>
                    <?php $i++; endforeach;?>
                </tbody>
