		...
		public function Menu_get_by_id($id = false) {
			if($id !== false) {
				$selectClause = " menu.MenuID, menu.ParentID, menu.Title, menu.Url, menu.Slug, menu.Types, menu.Description, menu.StaticContent, CAST(menu.IsStatic as UNSIGNED INT) as IsStatic,
								CAST(menu.Publish as UNSIGNED INT) as Publish, CAST(menu.IsClick as UNSIGNED INT) as IsClick, menu.Orders, CAST(menu.IsNewTab as UNSIGNED INT) as IsNewTab, menu.SEOTitle, menu.SEOKeyword, menu.SEODescription, ";
